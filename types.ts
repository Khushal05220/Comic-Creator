...
// This describes a single panel generated by the storyboard AI
export interface StoryPanelGenData {
  scene_description: string;
  dialogue: string;
  characters_present: string[];
}

// This describes a full page generated by the storyboard AI
export interface StoryPageGenData {
  layout: PageLayout;
  panels: StoryPanelGenData[];
}